...
from prob_unet.unet import Unet, NoNewNet
from prob_unet.utils import init_weights,init_weights_orthogonal_normal, l2_regularisation
import torch.nn.functional as F
from torch.distributions import Normal, Independent, kl
from unet3d import losses, config
import torch
...
class AxisAlignedConvGaussian(nn.Module):
    ...
    def __init__(self, input_channels, num_filters, no_convs_per_block, latent_dim, initializers, posterior=False):
        ...
        self.conv_layer = nn.Conv3d(num_filters[-1], 2 * self.latent_dim, 1, stride=1)
        self.show_img = 0
        self.show_seg = 0
        self.show_concat = 0
        self.show_enc = 0
...
class ProbabilisticUnet(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1, num_filters=[28,60,160,190], latent_dim=6, no_convs_fcomb=4, beta=10.0, **kwargs):
        ...
        self.unet = NoNewNet(self.input_channels, 28)
