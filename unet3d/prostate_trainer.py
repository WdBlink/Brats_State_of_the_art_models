        ...
        for i, t in enumerate(tqdm(train_loader)):
            ...
            if self.num_iterations % self.log_after_iters == 0:
                ...
                self.logger.info(
                    ...
                    f'Train_Dice:{train_eval_scores_duality.dice_WT}')
            ...
            with torch.no_grad():
                for i, t in enumerate(val_loader):
                    ...
                    if eval_score[0] < 0.5:
                        ...
                        self.logger.info(f'The Case {pid} score is {eval_score}!!!\n'
                ...
                self.logger.info(f'Validation finished. \n'
                                 ...
                                 f'Evaluation score \n'
                                 f'Val_dice:{val_scores_duality.dice_WT} \n'
